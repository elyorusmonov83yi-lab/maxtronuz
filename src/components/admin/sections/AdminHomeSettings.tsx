...
export const AdminHomeSettings: React.FC<AdminHomeSettingsProps> = ({
  ...
  const handleOgImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const currentOg: LocalizedString = typeof homeContent.ogImage === 'object' && homeContent.ogImage 
        ? homeContent.ogImage 
        : { uz: '', ru: '' };

      setHomeContent({
        ...homeContent,
        ogImage: { ...currentOg, [homeLang]: url }
      });
    } catch {
      // API orqali yuklab bo'lmasa fallback sifatida DataURL
  ...
  return (
    <form onSubmit={handleSaveHome} className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gray-900 border border-gray-800 p-2.5 rounded-3xl">
        ...
        {/* Til Tanlash */}
        <div className="flex gap-1.5 p-1 rounded-2xl bg-gray-950 border border-gray-800 shrink-0">
          {[
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-gray-950 border border-gray-800 text-sm text-white focus:border-blue-500 outline-none transition"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-gray-950 border border-gray-800 text-sm text-white font-bold focus:border-blue-500 outline-none transition"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-gray-950 border border-gray-800 text-sm text-white focus:border-blue-500 outline-none leading-relaxed transition"
                />
              </div>
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-center">
                ...
                <div className="sm:col-span-8 space-y-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                  >
