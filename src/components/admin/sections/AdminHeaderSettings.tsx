...
import { Layout, Save, Upload, Phone, Clock, MapPin, Truck, Trash2, Globe, Image as ImageIcon } from 'lucide-react';
...
export const AdminHeaderSettings: React.FC<AdminHeaderSettingsProps> = ({
  ...
  const handleFaviconUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const token = localStorage.getItem('maxtron_token');
  ...
  return (
    <form onSubmit={handleSaveHeader} className="space-y-6">
      ...
      <div className="bg-gray-900/40 p-6 rounded-3xl border border-gray-800 space-y-5">
              ...
              {headerSettings.logoImageUrl ? (
                <div className="relative flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl bg-rose-600/10 hover:bg-rose-600/20 text-rose-400 border border-rose-500/30 transition"
        ...
        {/* Logotip URL manzili (Qo'lda yoki avtomatik tushadigan joy) */}
        <div>
      ...
      {/* 🌟 2. FAVICON (SAYT IKONCHASI) SOZLAMASI */}
          ...
          <div className="md:col-span-8 space-y-3">
            ...
            <div className="flex flex-wrap gap-2.5">
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-cyan-600/10 hover:bg-cyan-600/20 text-cyan-400 border border-cyan-500/30 text-xs font-semibold flex items-center gap-2 transition cursor-pointer"
              >
                <Upload className="w-4 h-4" />
                <span>Favicon yuklash (ICO yoki PNG)</span>
              </button>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-xl bg-gray-950 border border-gray-800 text-xs text-white font-mono"
              />
            </div>
          </div>
        </div>
