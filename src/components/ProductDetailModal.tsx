        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800 bg-gray-950/60">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              onClick={handleShare}
              title="Ulashish"
              className="p-2 rounded-lg bg-gray-800 border border-gray-700 text-gray-400 hover:text-white cursor-pointer transition"
            >
            ...
            <div className="md:col-span-7 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 py-3">
                <div className="p-3 rounded-xl bg-gray-950/70 border border-gray-800">
                  ...
                  <div className="text-sm font-bold text-white flex items-center gap-1.5 mt-0.5">
                    ...
                    {product.warrantyMonths} {currentLang === 'ru' ? 'мес. гарантия' : 'oy rasmiy kafolat'}
                  </div>
                </div>

                <div className="p-3 rounded-xl bg-gray-950/70 border border-gray-800">
                  <div className="text-xs text-gray-500">
                    {currentLang === 'ru' ? 'Метрологическая поверка' : 'Metrologik qiyoslash'}
                  </div>
                  <div className="text-sm font-bold text-white flex items-center gap-1.5 mt-0.5">
                    <Sparkles className="w-4 h-4 text-blue-400" />
                    {currentLang === 'ru' ? 'Узстандарт 100%' : 'O‘zstandart 100%'}
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/25 transition-all transform hover:-translate-y-0.5 text-sm cursor-pointer"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-gray-800 hover:bg-gray-700 text-gray-200 font-medium rounded-xl border border-gray-700 text-sm transition cursor-pointer"
                >
                  <Download className={`w-4 h-4 ${downloading ? 'animate-bounce' : ''}`} />
                  <span>{downloading ? (currentLang === 'ru' ? 'Подготовка...' : 'Tayyorlanmoqda...') : 'PDF Паспорт'}</span>
                </button>
              </div>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="p-3.5 rounded-xl bg-gray-950/60 border border-gray-800 flex items-center justify-between text-xs sm:col-span-2">
                    <span className="text-gray-400">
                      {currentLang === 'ru' ? 'Сертификат и Госреестр' : 'Sertifikat va Davlat Reestri'}
                    </span>
