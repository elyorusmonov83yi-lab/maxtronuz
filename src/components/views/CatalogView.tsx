...
export const CatalogView: React.FC<CatalogViewProps> = ({
  ...
  const rawParam = categorySlug || categoryId || 'all';
  ...
  // 🌟 Ochiq turgan (Expand qilingan) ota kategoriyalar ID-lari
  ...
  // 🌟 Agar tanlangan kategoriya biror ota toifaning bolasi bo'lsa, o'sha ota toifani avtomatik ochish
  useEffect(() => {
  ...
  // 🌟 Mahsulotlar filtri (Ota tanlanganda uning barcha ichki bolalaridagi mahsulotlarni ham topadi)
  const filteredProducts = useMemo(() => {
    return productsList.filter((product) => {
      ...
      if (activeCategoryId !== 'all') {
        ...
        // Agar tanlangan kategoriya Ota bo'lsa, uning barcha ichki bolalarini tekshiramiz
  ...
  // 🌟 Qidiruv bo'yicha filtrlangan kategoriyalar
  ...
  return (
    <div className="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        {/* Chap Sidebar (Desktop) - 🌟 AKKORDEON DARAJARLI KATEGORIYA */}
              ...
              {filteredCategoriesTree.map((cat) => {
                ...
                return (
                  <div key={cat.id} className="space-y-1">
                    ...
                    {/* 🌟 Ichki bolalar (Child / Docherniy) Kategoriyalar */}
      ...
      {/* Mobile Drawer (Ichki bolalar bilan) */}
      {mobileFilterOpen && (
        <div className="fixed inset-0 z-50 lg:hidden flex">
          ...
          <div className="relative ml-auto w-full max-w-xs bg-gray-950 border-l border-gray-800 h-full p-6 overflow-y-auto flex flex-col justify-between shadow-2xl z-10">
            <div className="space-y-6">
              ...
              {/* Mobile kategoriyalar (Akkordeon) */}
