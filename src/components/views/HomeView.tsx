...
useEffect(() => {
    // Til o'zgarganda yoki sahifa yuklanganda CMS ma'lumotlarini bazadan qayta yangilaymiz
  ...
  }, [currentLang]); // 🌟 currentLang qo'shildi: til o'zgarganda qayta ishlaydi
  ...
  // Faqat asosiy Ota toifalar
  const mainParentCategories = categoriesList.filter(c => !c.parentId);

  // --- CMS Dinamik Matnlar (Tilni to'g'ri qo'llab-quvvatlaydigan holatda) ---
 // --- CMS Dinamik Matnlar (Bazadagi JSON kalitlarga to'liq moslashtirilgan) ---
  ...
  return (
    <div>
      {/* 🌟 Bosh Sahifa SEO & OpenGraph Meta Teglari */}
      ...
      {/* 2. Advantages Section (4 ta afzallik) */}
