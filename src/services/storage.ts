...
import { certificatesData as defaultCertificates } from '../data/certificates';
...
// 3. Standart Home Content (SEO va OG bilan birga)
...
let memoryCategories: CategoryInfo[] = [...defaultCategories];
let memoryCertificates: Certificate[] = [...defaultCertificates];
let memoryIndustries: IndustryInfo[] = []; // 🌟 Sanoat sohalari xotirasi
...
export const StorageService = {
  // 🌟 SANOAT SOHALARI VA VAZIFALAR (FINDER)
  ...
  // 🌟 To'liq MariaDB bazasi bilan sinxronlash
  async syncWithDatabase(): Promise<void> {
    try {
      ...
      // 1. Mahsulotlar (Sinxronlashda ID larni ham massiv qilib olamiz)
      ...
      // 3.1. Sanoat sohalari va vazifalar (Finder)
      ...
      // 5. Bosh sahifa (Home CMS) sozlamalari
      ...
      // 10. Buyurtmalar / Takliflar (Quotes)
...
// Bitta brendni saqlash yoki yangilash
